...
class WaypointLoader(object):
    ...
    def __init__(self):
        ...
        velocity_value = rospy.get_param('~velocity')
        self.velocity = self.kmph2mps(velocity_value)
    ...
    def decelerate(self, waypoints):
        ...
        for wp in waypoints[:-1][::-1]: # remove the last ont point and then reversed order 
